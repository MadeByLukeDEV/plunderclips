...
async function fetchClips(page: number, tag: string, search: string) {
...
export default function HomePage() {
  ...
  const { data, isLoading, isFetching } = useQuery({
    queryKey: ['clips', page, tag, search],
    queryFn: () => fetchClips(page, tag, search),
  });
    ...
    <div>
      ...
      <div className="relative border-b border-white/5 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 text-center">
          ...
          <h1 className="font-display text-7xl md:text-9xl font-900 text-white leading-none mb-4">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        {isLoading || isFetching ? (
          ...
          <div className="text-center py-24">
            ...
            <p className="text-white/30 text-sm font-body mb-6">No clips found. Be the first to submit one.</p>
            {user && (
              <Link href="/submit" className="btn-teal px-6 py-2 rounded text-sm inline-block">Submit a Clip</Link>
            )}
          </div>
        ) : (
          <>
