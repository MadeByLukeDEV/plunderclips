          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <a href={`https://twitch.tv/${streamer.twitchLogin}`} target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 border border-white/10 text-white/30 hover:border-teal/40 hover:text-teal font-display text-xs tracking-wider rounded transition-all">
                <ExternalLink className="w-3.5 h-3.5" />Twitch
              </a>
              {streamer.youtubeChannelId && (
                <a href={`https://www.youtube.com/channel/${streamer.youtubeChannelId}`} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-2 border border-white/10 text-white/30 hover:border-red-400/60 hover:text-red-400 font-display text-xs tracking-wider rounded transition-all">
